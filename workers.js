...
const serviceaccounts = [
    {
        ...
        "project_id": "indexsafeb2024",
        "private_key_id": "012caf6ffb6f56b0bcd87fb00632a1b10f7086fd",
        "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
        "client_email": "mfc-a4paphy6ffzm22mqmc1jbx1o9g@indexsafeb2024.iam.gserviceaccount.com",
        "client_id": "102281286346690755043",
        "auth_uri": "https://accounts.google.com/o/oauth2/auth",
        "token_uri": "https://oauth2.googleapis.com/token",
        "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
        "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/mfc-a4paphy6ffzm22mqmc1jbx1o9g%40indexsafeb2024.iam.gserviceaccount.com",
  ...
  const authConfig = {
      "siteName": "GDHub Nation", // Website name
      ...
      "refresh_token": "1//09VGFDb8A5D-6CgYIARAAGAkSNwF-L9Ir-VG1Ad5ON1oCfmNDY9pwi19eCP-1MwOBoja04wQsC_DyUNI5AYJFiXc9jeHDSvEzbEE", // Authorize token
      ...
      "roots":[
        {
            "id": "0AJF0G6GppZY8Uk9PVA",
            "name": "GDHub Nation",
            "protect_file_link": false,
            "auth": {"gdhubnation":"premium123"} /* Remove double slash before "auth" to activate id password protection */
        },
        {
            "id": "0ALMhqcoKSeEtUk9PVA",
            "name": "UPLOAD",
            "protect_file_link": false,
            "auth": {"userna6gme1":"passwgord1"} /* Remove double slash before "auth" to activate id password protection */
        },
        {
          "id": "0AA1co9203RJKUk9PVA",
          "name": "UPLOAD01",
          "protect_file_link": false,
          "auth": {"userna6gme1":"passwgord1"} /* Remove double slash before "auth" to activate id password protection */
        },
        {
            "id": "0AHgXYlPnrx23Uk9PVA",
            "name": "UPLOAD02",
            "protect_file_link": false,
            "auth": {"userna6gme1":"passwgord1"} /* Remove double slash before "auth" to activate id password protection */
        },
        {
            "id": "0AIOv2to7f2hmUk9PVA",
            "name": "UPLOAD03",
            "protect_file_link": false,
            "auth": {"userna6gme1":"passwgord1"} /* Remove double slash before "auth" to activate id password protection */
        },
  ...
  const uiConfig = {
      ...
      "logo_link_name": "https://i.ibb.co/D7r5VCF/GDHUBNATION-logo-3.png.png",
      ...
      "contact_link": "https://t.me/gdhubnation", // Link to Contact Button on Menu
      "copyright_year": "2023", // year of copyright, can be anything like 2015 - 2020 or just 2020
      "company_name": "Gdrivehub", // Name next to copyright
      "company_link": "https://t.me/gdhubnation", // link of copyright name
      ...
      "poster": "https://i.ibb.co/59mv2f0/Untitled-design.jpg", // Video poster URL or see Readme to how to load from Drive
      ...
      "unauthorized_owner_link": "https://t.me/gdhubnation", // Unauthorized Error Page Link to Owner
      "unauthorized_owner_email": "manrisky73@gmail.com", // Unauthorized Error Page Owner Email
  ...
  <html>
     ...
     <body>
        ...
        <div class="popupwindows warnpopup">
			...
			<p class="warnmessage">
				<br>This website is a powered by <a class="warn" href="https://t.me/gdhubnation" target="_blank">GDHub Nation</a>. <br>
				And yes its FREE!!!<br>
				<br></p>
			<h3 class="popuptitles">Join our Channels</h3>
			</p>
			<div class="btncreate">
				<button type="submit" class="btn btn-outline-info btn-sm btn-lg round closepopup"><a href="https://t.me/gdhubnation">Click here to Join</a></button>
			</div>
		</div>
           <div id="nav">
                   ...
                   <a class="navbar-brand" href="/">${uiConfig.logo_image ? '<img border="0" alt="'+uiConfig.company_name+'" src="'+uiConfig.logo_link_name+'" height="'+uiConfig.height+'" width="'+uiConfig.logo_width+'">' : uiConfig.logo_link_name}</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                       ...
                       <form class="d-flex" method="get" action="/0:search">
                          <input class="form-control me-2" name="q" type="search" placeholder="Search Here" aria-label="Search" value="" required="">
                          <marquee>Hi</marquee>
        ...
        <div>
           <div id="content" style="padding-top: ${uiConfig.header_padding}px;">
              <div class="container">
                 ...
                 <marquee behavior="scroll" direction="left" scrollamount="5">Hi, This is Index of Premium Telegram Channel - "<a href="https://t.me/gdhubnation">GDHub Nation</a>". Welcome to the HEAVEN</marquee>
